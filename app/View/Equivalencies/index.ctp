<div class="equivalencies index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('equivalent_id'); ?></th>
			<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($equivalencies as $equivalency): ?>
	<tr>
		<td><?php echo h($equivalency['Equivalency']['id']); ?>&nbsp;</td>
		<td><?php echo h($equivalency['Equivalency']['original_id']); ?>&nbsp;</td>
		<td><?php echo h($equivalency['Equivalency']['equivalent_id']); ?>&nbsp;</td>
		<td class="actions">
