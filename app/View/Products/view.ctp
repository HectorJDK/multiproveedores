...
<br>
	...
	<div class="row striped slim">
		...
		<div class="col-3 text-center inner-actions">
			...
			<!-- Para ver originales, descomentar esta linea. <button class="btn btn-success btn-block"><?php echo $this->Html->link(__('Ver originales'), array('action' => 'equivalent_to', $product['Product']['id'])); ?></button> -->
