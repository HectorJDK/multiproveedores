...
<div class="col-2">
  ...
  <li><?php echo $this->Html->link("Catálogo", array('controller' => 'productsSuppliers', 'action' => 'catalog', $catalog->supplier['id'])); ?> </li>
  <li><?php echo $this->Html->link("Historial", array('controller' => 'suppliers', 'action' => 'record', $catalog->supplier['id'])); ?> </li>
  <li><?php echo $this->Html->link("Tipos", array('controller' => 'suppliersTypes', 'action' => 'suppliersTypes', $catalog->supplier['id'])); ?> </li>
  <li><?php echo $this->Html->link("Origenes", array('controller' => 'originsSuppliers', 'action' => 'originsForSupplier', $catalog->supplier['id'])); ?> </li>
</ul>
</div>
